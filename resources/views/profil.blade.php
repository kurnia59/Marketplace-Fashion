		...
		<div class="row">
			<div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-profile">
						...
						@foreach($data as $d)
							@if($d->USER_PROFILE_PIC != NULL)
								<img src="{{ asset('assets/images/user/'.$d->USER_PROFILE_PIC) }}" alt="" class="rounded-circle">
							@else
						...
						{{ $d->USER_FIRSTNAME." ".$d->USER_LASTNAME }}
						</h5>
						<p>Joined {{ date('d F Y', strtotime($d->USER_TIME_CREATE)) }}</p>
						@endforeach
					</div>
					<!-- Dashboard Links -->
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				...
				<div class="widget personal-info">
					...
					@foreach($data as $d)
					<form action="{{ route('profil.update', $d->USER_ID) }}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
                {{ method_field('PUT') }}
						<!-- First Name -->
						<div class="form-group">
						    <label for="first-name">First Name</label>
						    <input type="text" name="firstname" value="{{ $d->USER_FIRSTNAME }}" class="form-control" id="first-name">
						</div>
						<!-- Last Name -->
						<div class="form-group">
						    <label for="last-name">Last Name</label>
						    <input type="text" name="lastname" value="{{ $d->USER_LASTNAME }}" class="form-control" id="last-name">
						</div>
						<!-- File chooser -->
						<div class="form-group choose-file">
							<i class="fa fa-user text-center"></i>
						    <input type="file" name="foto" class="form-control-file d-inline" id="input-file">
						 </div>
						<!-- Comunity Name -->
						<div class="form-group">
						    <label for="comunity-name">Phone</label>
						    <input type="text" name="phone" value="{{ $d->USER_PHONE }}" class="form-control" id="comunity-name">
						</div>
						<!-- Submit button -->
                ...
                {{ method_field('PUT') }}
						...
						<div class="form-group">
						    ...
						    <input type="password" name="oldpass" class="form-control" id="current-password">
						</div>
						<!-- New Password -->
						<div class="form-group">
						...
						<div class="form-group">
						    ...
						    <input type="password" name="newpass1" class="form-control" id="confirm-password">
						</div>
						<!-- Submit Button -->
                ...
                {{ method_field('PUT') }}
						...
						<div class="form-group">
						    ...
						    <input type="email" value="{{ $d->USER_EMAIL }}" class="form-control" id="current-email">
						</div>
						<!-- New email -->
						<div class="form-group">
